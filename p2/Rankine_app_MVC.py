...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.RC = rankineController(self.input_widgets, self.display_widgets) # instantiate a rankineController object and pass as arguments the two lists of widgets to be unpacked into the View
